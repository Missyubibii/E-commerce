                ...
                <form class="space-y-6" action="{{ route('login') }}" method="POST">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            ...
                            @error('email')
                                <p class="mt-1 text-sm text-red-600">{{ __('Thông tin này không hợp lệ.') }}</p>
                            @enderror
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <label for="remember" class="ml-2 block text-sm text-gray-900">Lưu thông tin đăng nhập</label>
                        </div>
                    </div>
